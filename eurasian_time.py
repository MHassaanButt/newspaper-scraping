...
class Eurasian_News():
    ...
    def News_Section(self, soup):
        try:
            news_section = soup.find(
                'a', attrs={'class': 'tdb-entry-crumb'}).get_text(strip=True)
        except:
    ...
    def Scrap_National_Links(self, url):
        ...
        if html_document is not None:
            ...
            print('connection error')
            return None
    def Scrap_Al_Jazeera(self, article_urls, name, **kwargs):
    ...
    def scrap_latest_news(self, latest_url,  **kwargs):
        ...
        df_latest = self.Scrap_Al_Jazeera(article_urls, 'Dawn Latest')
    ...
    def scrap_national_news(self,  latest_url, **kwargs):
        ...
        df_national = self.Scrap_Al_Jazeera(article_urls, 'Dawn National')
    ...
    def scrap_world_news(self,  latest_url, **kwargs):
        ...
        df_national = self.Scrap_Al_Jazeera(article_urls, 'Dawn International')
